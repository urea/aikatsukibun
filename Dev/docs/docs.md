# AikatsuKibun ドキュメント・インデックス (Dev/docs/docs.md)

## 管理ドキュメント
- **プロジェクト・ルール**: [.agent/GEMINI.md](../../.agent/GEMINI.md) 【Source of Truth】
- **現在進行中の計画**:
- **implementation_plan.md**: [システム・アーティファクト](../../implementation_plan.md) 【一時的】
- **20260519-1410_AikatsuKibun_進化実装計画案.md**: [進化実装計画案](./misc/20260519-1410_AikatsuKibun_進化実装計画案.md) 【Source of Truth】
